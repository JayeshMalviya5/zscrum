...
import CompanyCarousel from "@/components/company-carousle";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      <section className="mx-auto container py-16 text-center">
        <h1 className="text-6xl sm:text-7xl lg:text-8xl font-extrabold gradient-title pb-6 flex flex-col items-center">
          ...
          <span>
            ...
            <Image
              ...
              width={400}
              height={80}
              className="h-14 sm:h-24 mt-2 w-auto object-contain"
            />
          </span>
        </h1>
        <p className="mb-4 text-2xl font-extrabold text-gray-500 mx-auto">
          Enpower your team with our end to end bussiness tracking solution
        </p>
